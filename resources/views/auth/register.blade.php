                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input  style="margin-right:10px;" id="female" type="radio" name="gender" value="Female" required autocomplete="gender"><label for="female"  style="display:inline; margin-right:30px;">{{ __('Female') }}</label>

                                    <input style="margin-right:10px;" id="male" type="radio" name="gender" value="Male" required autocomplete="gender"><label for="male"  style="display:inline; ">{{ __('Male') }}</label>
